...
<div class="col-lg-2"><div role="navigation" id="sidebar" class="sidebar-offcanvas">
          <div class="list-group">
            ...
            <a class="list-group-item" href="competitions">All</a>
             <?php    
if ($competitions_categories) {
    foreach ($competitions_categories as $row) {
    $segments = array('competitions', 'get_competitions_categories', $row['competitions_cat_ID']);
        ?>
